// Wifi info
#ifndef STASSID
#define STASSID "Wi-fi SSID goes here"
#define STAPSK "Wi-fi password goes here"
#endif
...
// These are public defaults from the ESP8266 sample code; they probably won't be trusted
